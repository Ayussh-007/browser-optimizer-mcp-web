      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative px-4 py-1.5 text-sm font-medium rounded transition-colors ${isActive ? 'text-white' : 'text-[var(--color-text-secondary)] hover:text-white'
                  }`}
              >
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="px-4 py-1.5 text-sm font-medium bg-[var(--color-accent-purple)] text-white rounded hover:opacity-90 transition-opacity cursor-pointer"
          >
            Get Started
          </button>
        </div>
